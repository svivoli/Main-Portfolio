        ...
        <article className="article-portfolio">
            ...
            <section class="portfolio1">
                <div class="image-hover-wrapper">
                    <a href="https://u-incahoots.herokuapp.com/" target="_blank"><img src="../../images/portfolio/cahoots.png"
            ...
            <section className="portfolio1">
                <div className="image-hover-wrapper">
                    <a href="https://g00gleb00ks.herokuapp.com/" target="_blank"><img src="../../images/portfolio/books.png"
                        style={{width: "600px"}}></img>
            ...
            <section className="portfolio1">
                <div className="image-hover-wrapper">
                    <a href="https://employee-direct0ry.herokuapp.com/" target="_blank"><img src="../../images/portfolio/employee.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio1">
                <div className="image-hover-wrapper">
                    <a href="https://track-your-budg3t.herokuapp.com/" target="_blank"><img src="../../images/portfolio/budget.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio1">
                <div className="image-hover-wrapper">
                    <a href="https://w0rkout-tracker.herokuapp.com/" target="_blank"><img src="../../images/portfolio/fitness.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio1">
                <div className="image-hover-wrapper">
                    <a href="https://jeretc79.github.io/project1/" target="_blank"><img src="../../images/portfolio/shows.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio3">
                <div className="image-hover-wrapper">
                    <a href="https://peer-one.herokuapp.com/" target="_blank"><img src="../../images/portfolio/peerup.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio2">
                <div className="image-hover-wrapper">
                    <a href="https://svivoli.github.io/Weather-Dashboard/" target="_blank"><img src="../../images/portfolio/weather.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio3">
                <div className="image-hover-wrapper">
                    <a href="https://svivoli.github.io/Daily-Planner/" target="_blank"><img src="../../images/portfolio/daily.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio3">
                <div className="image-hover-wrapper">
                    <a href="https://stark-everglades-05320.herokuapp.com/" target="_blank"><img src="../../images/portfolio/burger.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio3">
                <div className="image-hover-wrapper">
                    <a href="https://aqueous-journey-39158.herokuapp.com/" target="_blank"><img src="../../images/portfolio/note.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio4">
                <div className="image-hover-wrapper">
                    <a href="https://svivoli.github.io/Portfolio1/" target="_blank"><img src="../../images/portfolio/portfolio0.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio3">
                <div className="image-hover-wrapper">
                    <a href="https://svivoli.github.io/Portfolio-Pink-Grey/" target="_blank"><img src="../../images/portfolio/portfolio1.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
            ...
            <section className="portfolio3">
                <div className="image-hover-wrapper">
                    <a href="https://svivoli.github.io/Portfolio-Simple-Blue/" target="_blank"><img src="../../images/portfolio/portfolio2.png"
                        style={{width: "600px"}}></img>
                        <span className="image-hover-wrapper-reveal">
